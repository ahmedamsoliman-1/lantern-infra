...
check_record lantern-core.home.arpa "$LANTERN_CORE_IP"
check_record dashboard.home.arpa "$LANTERN_CORE_IP"
check_record status.home.arpa "$LANTERN_CORE_IP"
check_record dns.home.arpa "$LANTERN_CORE_IP"
check_record photos.home.arpa "$LANTERN_CORE_IP"
check_record windows.home.arpa "$WINDOWS_LAN_IP"
